...
\begin{rSection}{Technical Skills}
    ...
    \item[Frameworks and Tools:] ReactJS, NodeJS, PostgreSQL, Git, REST, Agile 
    \end{description}
\end{rSection}
...
\begin{rSection}{Projects}
    \begin{rSubsection}{Santa Cruz Stranding Map}{\href{https://github.com/lmlstrandingnetwork/lml-stranding-map}{github.com/lmlstrandingnetwork/lml-stranding-map}}{UCSC Long Marine Lab}{ReactJS, ExpressJS, NodeJS, Firebase}
    ...
    \begin{rSubsection}{Pollen Planter}{\href{https://www.devpost.com/software/pollenplanter}{devpost.com/software/pollenplanter}}{UCSC CruzHacks 2020 Winner}{React Native, NodeJS, Firebase}
